  ...
  const platforms = {
    ...
    whatsapp: {
      ...
      isIncoming: (msgEl) => {
        ...
        return (
          msgEl.classList?.contains('message-in') ||
          !!msgEl.querySelector('div.message-in') ||
          !!msgEl.closest('div.message-in')
        );
      },
      isOutgoing: (msgEl) => {
        if (!msgEl) return false;
        return (
          ...
          !!msgEl.querySelector('div.message-out') ||
          !!msgEl.closest('div.message-out')
        );
      },
      getSendButton: () => {
        return (
